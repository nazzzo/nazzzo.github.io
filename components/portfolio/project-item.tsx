        ...
        <div className="project-card w-[360px] xl:w-[440px] 2xl:w-[560px] mt-10 dark:bg-gray-600 overflow-hidden rounded-xl shadow shadow-xl">
            ...
            <div className="p-4 flex flex-col">
                ...
                <div className="flex items-center py-4 text-white">
                    <div className="bg-red-400 hover:bg-orange-700 dark:bg-gray-800 dark:hover:bg-gray-500 w-[120px] p-2 flex items-center justify-center rounded-lg transition-all duration-150"><a href={github}>깃허브 바로가기</a></div>
