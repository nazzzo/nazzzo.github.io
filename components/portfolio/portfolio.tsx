...
const projects = [
    {
        ...
        details: `뭄바이 네트워크를 기반으로 하는 NFT 마켓 플레이스입니다
컬렉션 생성과 NFT 민팅 과정에 생성형 AI를 도입했고 NFT 구입 및 판매, 스윕을 통한 대량 구매와 경매 기능, 에어드롭 등
오픈씨나 Blur와 같은 유명 NFT 마켓 플랫폼에서 사용되는 주요 기능들을 대부분 구현하고 있습니다

- 컬렉션 생성: 컬렉션의 설명란을 생성형 AI의 프롬프트로 활용하고 있으며 AI를 통한 이미지 생성은 Eden AI에서 제공중인 API를 사용했습니다 
...
프론트엔드는 NextJs, 백엔드는 NestJs, 스타일은 테일윈드 CSS를 기반으로 작성되었으며
프로젝트 내에서 컨트랙트 작성, 프론트와 백엔드 전반적인 코드 작성과 리팩토링, 배포를 담당했습니다
...
- 계좌 찾기: 니모닉키를 입력해서 계좌를 되찾을 수 있습니다
        `,
    },
    {
        id: 3,
...
(+ 설정한 지역에서 최대 10km 밖의 글은 표시되지 않습니다.)
...
프론트엔드 작업과 지역 인증 & 채팅 기능, 백엔드의 SQL 쿼리문 작성 업무를 중점적으로 담당했습니다.
        `,
    },
    {
        id: 4,
...
Nunjucks 템플릿 엔진을 기반으로 제작되었으며 게시글 작성시 이미지 등록을 위해 Multer를, 마크다운 문법 지원을 위해 ToastUI 라이브러리를 적용했습니다
