...
const projects = [
    {
        ...
        details: `뭄바이 네트워크를 기반으로 동작하는 NFT 마켓 플레이스입니다
컬렉션 생성과 NFT 민팅 과정에서 이미지 생성 AI(Eden AI에서 제공하는 이미지 생성 API)를 활용했고
NFT 구입 및 판매, 장바구니와 Sweep 슬라이더를 통한 대량 구매, 경매 기능, 에어드롭 등
