...
const projects = [
    {
        ...
        images: ['http://localhost:3000/project-images/rooftop-1.png', 'http://localhost:3000/project-images/rooftop-2.png', 'http://localhost:3000/project-images/rooftop-3.png'],
    ...
    },
    {
        ...
        images: ['http://localhost:3000/project-images/wallet-1.png', 'http://localhost:3000/project-images/wallet-2.png', 'http://localhost:3000/project-images/wallet-3.png'],
    ...
    },
    {
        ...
        images: ['http://localhost:3000/project-images/mango-0.png', 'http://localhost:3000/project-images/mango-1.png', 'http://localhost:3000/project-images/mango-2.png', 'http://localhost:3000/project-images/mango-3.png','http://localhost:3000/project-images/mango-4.png'],
    ...
    },
    {
        ...
        images: ['http://localhost:3000/project-images/ipk-1.png', 'http://localhost:3000/project-images/ipk-2.png', 'http://localhost:3000/project-images/ipk-3.png'],
